...
from hf_utils import download_hf_uris, parse_hf_uri
...
def load_transcoder_set(
    ...
    if transcoder_config_file == "gemma":
        transcoder_config_file = Path("../configs/gemmascope-l0-0.yaml")
        scan = "gemma-2-2b"
    elif transcoder_config_file == "llama":
        transcoder_config_file = Path("../configs/llama-relu.yaml")
